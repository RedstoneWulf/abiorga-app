        ...
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="hidden sm:block px-3 py-1.5 text-xs bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition font-medium"
            >
              Abmelden
            </button>
          </div>
        ...
        {showNotifications && (
          <div className="absolute right-4 top-14 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-xl border dark:border-gray-700 z-50">
            ...
            <div className="max-h-64 overflow-y-auto">
              <div className="p-3 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 shadow-sm overflow-hidden">
          <div className="p-5">
            ...
            <div className="flex items-end justify-between mb-4">
              ...
              <span className="text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-2.5 py-1 rounded-lg">
                {goalPercent}%
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {topTask ? (
              <Link
                ...
                className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-4 hover:border-blue-300 hover:shadow-md transition-all group"
              >
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 rounded-lg flex items-center justify-center text-sm">
                    📋
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-4">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-8 h-8 bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-300 rounded-lg flex items-center justify-center text-sm">
                    ✓
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-4">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-8 h-8 bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-300 rounded-lg flex items-center justify-center text-sm">
                  📅
                </div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <span className="text-xs text-gray-400">{formatDate(nextEvent.date)}</span>
...
function ModuleCard({
  ...
  if (href) {
    return (
      <Link
        href={href}
        className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-4 text-center hover:border-blue-300 hover:shadow-md transition-all"
      >
        {content}
      </Link>
    );
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-4 text-center opacity-60">
      {content}
    </div>
  );
}